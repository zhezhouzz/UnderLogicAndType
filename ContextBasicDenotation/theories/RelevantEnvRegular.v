(** * BasicDenotation.RelevantEnvRegular

    Regularity, environment-agreement, and normalization support for relevant
    environments.  The definitions and notations live in [RelevantEnvCore]. *)

From ContextBasicDenotation Require Import Notation StoreTyping TermSyntax TermOpen
  BasicTypingFormula RelevantEnvCore.
