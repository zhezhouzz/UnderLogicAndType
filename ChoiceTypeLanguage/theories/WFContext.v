(** * ChoiceTypeLanguage.WFContext

    Formation/scoping predicates for type contexts. *)

From ChoiceTypeLanguage Require Export WFChoiceTy.
...
Proof.
  ...
  - destruct Hbasic as [Hx Hτ]. split.
    + set_solver.
    + eapply basic_choice_ty_mono; [exact HDE|exact Hτ].
...
Proof.
  ...
  - destruct Hbasic as [_ Hτ].
    apply basic_choice_ty_fv_subset. exact Hτ.
...
Lemma basic_ctx_bind_lc D x τ :
  ...
  lc_choice_ty τ.
Proof.
  intros [_ Hτ]. apply (basic_choice_ty_lc D). exact Hτ.
Qed.
