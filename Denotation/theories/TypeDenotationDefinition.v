...
Lemma formula_open_env_denot_guard η Σ τ e :
  ...
  formula_open_env η
    (FAnd (choice_ty_wf_formula (denot_relevant_env Σ τ e) τ)
...
Proof.
  ...
  rewrite formula_open_env_choice_ty_wf_formula.
  2:{
  ...
  - destruct τ as [b φ|b φ|τ1 τ2|τ1 τ2|τ1 τ2|τx τr|τx τr].
    ...
    + cbn [denot_ty_lvar_gas].
      ...
      2:{
        ...
        * apply elem_of_union_r. cbn [choice_ty_lvars choice_ty_lvars_at].
          set_solver.
      }
      2: exact Hinj.
      rewrite (IH Σ τ2 e η).
  ...
  - destruct τ as [b φ|b φ|τ1 τ2|τ1 τ2|τ1 τ2|τ1 τ2|τ1 τ2];
    ...
    + rewrite (IH Σ1 Σ2 τ1 e X).
      2: { intros v Hv. apply Hsub.
           ...
           cbn [choice_ty_lvars choice_ty_lvars_at] in *.
           set_solver. }
      2: exact Heq.
