...
Lemma res_models_open_denot_ty_lvar_guard_to_open
  ...
  m ⊨ formula_open k y
    (FAnd (choice_ty_wf_formula Σ τ)
      (FAnd (basic_world_formula Σ)
        (FAnd (expr_basic_typing_formula Σ e (erase_ty τ))
              (expr_total_formula e)))) ->
  m ⊨
    FAnd (choice_ty_wf_formula (lty_env_open_one k y Σ) (cty_open k y τ))
...
Proof.
  ...
  split.
  - rewrite formula_open_choice_ty_wf_formula in Hwf.
    exact Hwf.
  - split.
  ...
  - cbn [denot_ty_lvar_gas].
    ...
    + unfold denot_relevant_env, denot_relevant_lvars.
      pose proof (lty_env_restrict_lvars_fv_subset
        Σ (choice_ty_lvars τ ∪ tm_lvars e)) as Hsubfv.
      rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
      set_solver.
    ...
    + rewrite formula_open_and.
      ...
      * rewrite denot_relevant_env_open_one by exact Hy.
        ...
        -- rewrite formula_open_over_body in Hbody.
           exact Hbody.
           ++ exact Hy.
           ++ unfold fv_cty, choice_ty_lvars in Hτ.
              cbn [choice_ty_lvars_at] in Hτ.
      ...
      * unfold denot_relevant_env, denot_relevant_lvars.
        pose proof (lty_env_restrict_lvars_fv_subset
          Σ (choice_ty_lvars (CTOver b φ) ∪ tm_lvars e)) as Hsubfv.
        rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
        set_solver.
    + rewrite formula_open_and.
      repeat rewrite res_models_and_iff.
      ...
      * unfold denot_relevant_env, denot_relevant_lvars.
        pose proof (lty_env_restrict_lvars_fv_subset
          Σ (choice_ty_lvars (CTUnder b φ) ∪ tm_lvars e)) as Hsubfv.
        rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
        set_solver.
    + rewrite formula_open_and.
      repeat rewrite res_models_and_iff.
      ...
      * rewrite denot_relevant_env_open_one by exact Hy.
        ...
        -- rewrite formula_open_and in Hbody.
           ...
           ++ apply (proj1 (IH k Σ τ1 e m HΣ Hy
                ltac:(unfold fv_cty, choice_ty_lvars in Hτ;
                  cbn [choice_ty_lvars_at] in Hτ;
      ...
      * unfold denot_relevant_env, denot_relevant_lvars.
        pose proof (lty_env_restrict_lvars_fv_subset
          Σ (choice_ty_lvars (CTInter τ1 τ2) ∪ tm_lvars e)) as Hsubfv.
        rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
        set_solver.
    + rewrite formula_open_and.
      repeat rewrite res_models_and_iff.
      ...
      * rewrite denot_relevant_env_open_one by exact Hy.
        ...
        -- rewrite formula_open_or in Hbody.
           ...
           ++ eapply formula_fv_denot_ty_lvar_gas_scope_from_guard_pre_open;
                [| exact HguardF].
              unfold choice_ty_lvars. cbn [choice_ty_lvars_at]. set_solver.
           ++ eapply formula_fv_denot_ty_lvar_gas_scope_from_guard_pre_open;
                [| exact HguardF].
              unfold choice_ty_lvars. cbn [choice_ty_lvars_at]. set_solver.
           ++ intros Hτ1.
           ...
           ++ transitivity
              ...
              ** pose proof (denot_guard_term_type_fv_scope
                 ...
                 --- apply elem_of_union_r.
                     unfold fv_cty, choice_ty_lvars in Ha |- *.
                     cbn [cty_open choice_ty_lvars_at].
      ...
      * unfold denot_relevant_env, denot_relevant_lvars.
        pose proof (lty_env_restrict_lvars_fv_subset
          Σ (choice_ty_lvars (CTUnion τ1 τ2) ∪ tm_lvars e)) as Hsubfv.
        rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
        set_solver.
    + rewrite formula_open_and.
      repeat rewrite res_models_and_iff.
      ...
      * unfold denot_relevant_env, denot_relevant_lvars.
        pose proof (lty_env_restrict_lvars_fv_subset
          Σ (choice_ty_lvars (CTSum τ1 τ2) ∪ tm_lvars e)) as Hsubfv.
        rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
        set_solver.
    + rewrite formula_open_and.
      repeat rewrite res_models_and_iff.
      ...
      * unfold denot_relevant_env, denot_relevant_lvars.
        pose proof (lty_env_restrict_lvars_fv_subset
          Σ (choice_ty_lvars (CTArrow τx τr) ∪ tm_lvars e)) as Hsubfv.
        rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
        set_solver.
    + rewrite formula_open_and.
      repeat rewrite res_models_and_iff.
      ...
      * unfold denot_relevant_env, denot_relevant_lvars.
        pose proof (lty_env_restrict_lvars_fv_subset
          Σ (choice_ty_lvars (CTWand τx τr) ∪ tm_lvars e)) as Hsubfv.
        rewrite lvars_fv_union, choice_ty_lvars_fv, tm_lvars_fv in Hsubfv.
        set_solver.
Qed.
