...
Proof.
  ...
  change (v ∈ context_tm_support (CTArrow τx τr) e1) in Hvrel1.
  change (v ∈ context_tm_support (CTArrow τx τr) e2) in Hvrel2.
  unfold lty_env_restrict_lvars.
  rewrite !storeA_restrict_lookup.
  destruct (decide (v ∈ context_tm_support (CTArrow τx τr) e1)) as [_|Hbad];
    [|exfalso; exact (Hbad Hvrel1)].
  destruct (decide (v ∈ context_tm_support (CTArrow τx τr) e2)) as [_|Hbad];
