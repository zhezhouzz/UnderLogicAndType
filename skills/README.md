...
| [26_denotation_extensional_equality.md](26_denotation_extensional_equality.md) | Denotation equality：qualifier/formula 用 extensional equality/setoid，TypeDenotation 自底向上证明 |
...
| [22_choice_instantiation_migration.md](22_choice_instantiation_migration.md) | 旧 ChoiceType instantiation 迁移记录；当前 split 后只作 LN/substitution 背景 |
