(** * ContextAlgebra.Resource
    ...
    file only so existing imports of [ContextAlgebra.Resource] continue to
    resolve while callers are moved to [ResourceInterface]. *)

From ContextAlgebra Require Export ResourceInterface ResourceExtensionCompat.
